...
class MyApplication(arcade.Window):
    ...
    def on_draw(self):
        ...
        # Draw the square and setting it to true to appear when space key is pressed
        if self.draw_rectangle:
            arcade.draw_rectangle_filled(
                SCREEN_WIDTH // 2, SCREEN_HEIGHT//2, SQUARE_WIDTH, SQUARE_HEIGHT, arcade.color.YELLOW)
    ...
    def on_key_press(self, key, key_modifiers):
        ...
        # See if the user just hit space.
            ...
            # shows square - space key pressed
    ...
    def on_key_release(self, key, key_modifiers):
        ...
        if key == arcade.key.SPACE:
            ...
            # desappear square - finger off key
            self.draw_rectangle = False
